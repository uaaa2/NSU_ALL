...
#train_data의 20프로를 시험데이터로 뺌 더 신뢰 가능한 수치, vali가 가장 낮은 곳이 최적의 weight 
#test , vali, train 비율을 어떻게 정할지 
#vali가 가장 낮은 곳을 찾아야 함 valiloss가 n번이상 갱신되지 않는경우 최적의 값을 찾았다고 판단하여 멈춤
#알아서 멈추기 때문에 많은 횟수를 돌림
...
submit_csv.to_csv(path + "sunmission_0717_1200.csv") #"C:\NSU_all\_data\sunmission_0717_.csv" 파일 생성
